...
public class PainelPerfil extends JPanel {
    ...
    private Image perfil = new ImageIcon(getClass().getResource("/logiFund.png")).getImage();
    Login loginActual;
    ...
    public PainelPerfil(Recenseador r) {
        ...
        fotoPanel.setBackground(new Color(0x2B2B2B));

        ImageIcon icon = carregarFoto();
        ...
        JLabel lblBairro = new JLabel("Província de Actuação: Maputo"); //+ r.getBairro().getNome());
    ...
    // ===========================================================
    private ImageIcon carregarFoto() {
        String path = "img.png";
        ...
        try {
            ...
            ImageIcon ic = new ImageIcon("logiFund.png");
            Image img = ic.getImage().getScaledInstance(130, 130, Image.SCALE_SMOOTH);
            return new ImageIcon(img);
        }
    }
